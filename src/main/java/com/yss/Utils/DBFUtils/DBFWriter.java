...
public class DBFWriter extends DBFBase {
    ...
    /**
     ...
     dbfFile. The file passed in shouls be a valid DBF file.
     hrows DBFException if the passed in file does exist but not a valid DBF file, or if an IO error occurs.
     */
