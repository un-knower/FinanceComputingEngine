...
object SjsjgContants {
    ...
    /** 深交所：中小企业板启用003000-004999代码段日期(YYYYMMDD) */
    val CON0S0_KEY = "中小企业板启用003000-004999代码段日期(YYYYMMDD)"
    /** 上海回购价格位数 */
    ...
    val CON20_KEY = "深圳交易数据来源"    // 0:未选中    1:选中
    val CON20_KEY_1 = "深圳交易数据来源值"  //0: 深交所回报数据  1：深圳中登结算数据  2：深交所V5接口XML文件 3：深交所V5接口数据库直连 4：深交所V5接口成交汇总
